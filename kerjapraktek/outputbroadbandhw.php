...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.html">PRE KONFIGURASI</a></h1>
			<ul>
	...
	<section class="label">
		<div class="container">
        <p><a href="index.php">HOME </a> / <a href="service.php">PRE-KONFIG</a> /<a href="servicebd.php">SWITCH HUAWEI</a> / TEMPLATE PREKONFIG</p>
		</div>
	</section>
<body>
    <center> 
...
ip address <?php echo $_POST["ip"];?> <br> <?php echo $_POST["sm"];?> <br>
undo shutdown <br>
quit <br>
...
dhcp snooping enable
 ...
 dhcp option82 format user-defined "<?php echo $_POST["sid"];?>"<br>
undo shutdown <br>
quit <br>
interface GigabitEthernet 0/0/1 <br>
port link-type trunk <br>
port trunk allow-pass vlan <?php echo $_POST["nms"];?> <br> <?php echo $_POST["service"];?>
dhcp snooping enable <br>
